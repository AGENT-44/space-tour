...
const Technology = () => {
  ...
  const ImageNavClass =
    "h-12 w-12 py-[0.6rem] sm:h-14 sm:w-14 sm:py-[0.7rem] sm:px-5  transition-all px-4 border-gray-600 rounded-full text-white border";
  const ImageNavClassActive =
    "h-12 w-12 py-[0.6rem] sm:h-14 sm:w-14 sm:py-[0.7rem] sm:px-5  transition-all bg-white px-4 border-gray-600 rounded-full text-black border";
  return (
    <div className="h-screen  bg-no-repeat relative top-0 bg-cover  bg-right lg:bg-bg-technology-desktop sm:bg-bg-tech-tablet bg-bg-tech-mobile">
      ...
      <div className="translate-y-44 sm:translate-y-48">
        <img
          className="tall:h-auto tall:w-auto h-[11rem]  w-full sm:w-full sm:h-[18rem]"
          src={
            activeNav == 0
              ? spaceShipLandscape
              : activeNav == 1
      ...
      {/* IMAGE NAVIGATION */}
      <div className="mt-52 sm:mt-60 flex gap-5 text-center font-bellefair text-lg sm:text-2xl justify-center">
      ...
      <main>
        {/* Terminology */}
        <div className="tall:mt-4 mt-5 sm:mt-10 ml-5 text-center">
          <h2 className="text-[#D0D6F9] uppercase font-barlow tracking-widest text-xl sm:text-2xl">
            The Terminology ...
          </h2>
        </div>
        {/* Tech Name */}
        <div className="text-white  mt-2">
          <h1 className="text-center font-bellefair uppercase text-3xl sm:text-4xl">
