...
const Destination = () => {
  ...
  return (
    <>
      <div className="h-[100vh] tall:h-[125vh] tall2:h[102vh]  sm:h-screen sm:bg-bg-destination-tablet  bg-no-repeat  w-screen top-0 bg-cover bg-right bg-bg-destination-mobile lg:bg-bg-destination-desktop">
