  ...
  return (
    <>
      <div className="h-screen sm:bg-bg-destination-tablet  bg-no-repeat  w-screen top-0 bg-cover bg-right bg-bg-destination-mobile lg:bg-bg-destination-desktop">
        <div className="border lg:h-30 lg:w-[26rem] sm:absolute sm:translate-x-0 sm:translate-y-0 sm:top-32 sm:left-12 lg:static   lg:translate-x-48 lg:translate-y-64 absolute top-28 left-1/4">
